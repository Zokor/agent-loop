...
use config::{
    Config, DEFAULT_DECOMPOSITION_MAX_ROUNDS, DEFAULT_DIFF_MAX_LINES,
    DEFAULT_PLANNING_MAX_ROUNDS, DEFAULT_REVIEW_MAX_ROUNDS, DEFAULT_TIMEOUT_SECONDS,
};
...
mod tests {
    ...
    fn environment_help_contains_migration_note() {
        let help = environment_help();
        assert!(
            help.contains("max_rounds / MAX_ROUNDS has been renamed to review_max_rounds / REVIEW_MAX_ROUNDS"),
